...
Examples:
  python -m simage resolve --db out/images.db --import-json out/civitai_export.json
  python -m simage resolve --db out/images.db --import-map  out/civitai_map.json
  python -m simage resolve --db out/images.db --import-map  out/civitai_map.csv
  python -m simage resolve --db out/images.db --rewrite
  python -m simage resolve --db out/images.db --import-json out/civitai_export.json --rewrite
"""
